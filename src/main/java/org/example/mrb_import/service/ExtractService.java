...
public class ExtractService {
    ...
    public ExtractService(RoomManagementMapper roomManagementMapper,
    ...
    public void process(String fileName, Integer partnerId,String outputPath) throws SQLException {
        ...
        try {
            ...
            for (CSVRecord record : records) {
                ...
                try {
                    processRecord(record, partnerId, LocalDateTime.now(), connection,outputPath);
    ...
    private void processRecord(CSVRecord record, Integer partnerId, LocalDateTime now, Connection connection,String outputPath) throws JsonProcessingException, SQLException {
        ...
        roomImageManagements.forEach(e->{
            String newPath = FileUtils.saveImageToFile(e.getImagePath(), path);
            imagesInLocal.add(newPath);
        });
